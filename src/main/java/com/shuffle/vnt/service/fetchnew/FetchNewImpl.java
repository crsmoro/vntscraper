...
import com.shuffle.vnt.service.fetchnew.model.FetchNew;

public class FetchNewImpl implements com.shuffle.vnt.service.fetchnew.FetchNew {
	...
	public List<Torrent> fetch() {
		...
		trackerManager = TrackerManager.getInstance(getTrackerUserData().getTracker(), getTrackerUserData().getUsername(), VntSecurity.decrypt(getTrackerUserData().getPassword(), VntSecurity.getPasswordKey()));
